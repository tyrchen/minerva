...
const CONTENT_TYPE_SAMPLEDATASET: ::mime::Mime = ::mime::APPLICATION_JSON;
::pin_project_lite::pin_project! {
    /// A [`Future`](std::future::Future) aggregating the body bytes of a [`Request`] and constructing the
    /// [`SampleDatasetInput`](crate::input::SampleDatasetInput) using modelled bindings.
    pub struct SampleDatasetInputFuture {
        inner: std::pin::Pin<Box<dyn std::future::Future<Output = Result<crate::input::SampleDatasetInput, ::aws_smithy_http_server::protocol::rest_json_1::runtime_error::RuntimeError>> + Send>>
    }
}

impl std::future::Future for SampleDatasetInputFuture {
    type Output = Result<
...
impl<B>
    ::aws_smithy_http_server::request::FromRequest<
        ...
        B,
    > for crate::input::SampleDatasetInput
where
        ...
        From<<B as ::aws_smithy_http_server::body::HttpBody>::Error>,
{
    ...
    type Future = SampleDatasetInputFuture;

    fn from_request(request: ::http::Request<B>) -> Self::Future {
        let fut = async move {
            if !::aws_smithy_http_server::protocol::accept_header_classifier(
                request.headers(),
                &CONTENT_TYPE_SAMPLEDATASET,
            ) {
                return Err(::aws_smithy_http_server::protocol::rest_json_1::rejection::RequestRejection::NotAcceptable);
            }

            crate::protocol_serde::shape_sample_dataset::de_sample_dataset_http_request(request)
                .await
                .map_err(Into::into)
        };
...
impl
    ::aws_smithy_http_server::response::IntoResponse<
        ::aws_smithy_http_server::protocol::rest_json_1::RestJson1,
    > for crate::output::SampleDatasetOutput
{
    fn into_response(self) -> ::aws_smithy_http_server::response::Response {
        match crate::protocol_serde::shape_sample_dataset::ser_sample_dataset_http_response(self) {
...
impl
    ::aws_smithy_http_server::response::IntoResponse<
        ::aws_smithy_http_server::protocol::rest_json_1::RestJson1,
    > for crate::error::SampleDatasetError
{
    fn into_response(self) -> ::aws_smithy_http_server::response::Response {
        match crate::protocol_serde::shape_sample_dataset::ser_sample_dataset_http_error(&self) {
            Ok(mut response) => {
